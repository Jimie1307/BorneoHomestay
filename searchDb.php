...
<?php
$state = $_POST['state'];
$maxPrice = $_POST['priceRange']+1;
$rating = $_POST['rating']+1;
//echo $state."<br>";
//echo $maxPrice;

//buat sql utk tunjuk rumah2 area situ and ada range bwh that harga
	$sql = "SELECT * from homestay WHERE homestayState = '$state' AND homestayPrice < '$maxPrice' AND rating < $rating";
	
if($_POST['state'] == "0"){
	$sql = "SELECT * from homestay WHERE homestayPrice < '$maxPrice' AND rating < $rating ";
